...
public class BladderContinence{
    public var id : Int?
    ...
    public var bladderNotes : String?
...
*/
    public class func modelsFromDictionaryArray(array:NSArray) -> [BladderContinence]
    {
        var models:[BladderContinence] = []
        for item in array
        {
            models.append(BladderContinence(dictionary: item as! NSDictionary)!)
        }
        return models
    }
...
*/
    required public init?(dictionary: NSDictionary) {
        ...
        bladderNotes = dictionary["bladderNotes"] as? String
...
*/
    public func dictionaryRepresentation() -> NSDictionary {
        ...
        dictionary.setValue(self.bladderNotes, forKey: "bladderNotes")
