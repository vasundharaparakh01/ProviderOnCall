//
//  RecursiveBPCell.swift
//  appName
//
//  Created by Vasundhara Parakh on 2/24/20.
//  Copyright © 2020 smartData Enterprises (I) Ltd. All rights reserved.
//

import UIKit
protocol RecursiveBPCellDelegate {
...
class RecursiveBPCell: UITableViewCell {
    var delegate: RecursiveBPCellDelegate?
    ...
    extension RecursiveBPCell : UIPickerViewDelegate,UIPickerViewDataSource{
